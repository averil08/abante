...
const QueueStatus = () => {
  ...
  const {
    ...
    avgWaitTime,
    setActivePatient,
    clearActivePatient, // Added new function
    requeuePatient,
    isLoadingFromDB // Added loading state
  ...
  // Also treat high temp queue numbers (>= 900000) as pending
  ...
  if (isLoadingFromDB) {
    return (
      <div className="min-h-screen flex items-center justify-center text-gray-700">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-green-600 mr-3"></div>
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6">
                    ...
                    <div className="block lg:hidden space-y-3">
                      {doctorPatients.map(patient => (
                        <div
                          key={patient.queueNo}
                          className={`border rounded-lg p-3 ${patient.queueNo === currentPatient.queueNo
                      ...
                      <table className="w-full border-collapse">
                        ...
                        <tbody>
                          {doctorPatients.map(patient => (
                            <tr
                              key={patient.queueNo}
                              className={`border-b ${patient.queueNo === currentPatient.queueNo
    ...
    return (
      <div className="flex w-full min-h-screen">
        ...
        <div className="flex-1 min-h-screen bg-gray-50 ml-0 md:ml-52 p-4">
          <div className="max-w-[800px] mt-[20px] sm:mt-[50px] w-full mx-auto space-y-6">
            <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 text-center">
              <Badge className={`text-sm sm:text-lg mb-4 ${currentPatient.status === 'cancelled'
                ? 'bg-red-100 text-red-700'
              ...
              {isAppointmentPending ? (
                <div className="text-4xl sm:text-5xl font-bold text-amber-600 mb-6 animate-pulse">Pending</div>
              ) : (
                <div className="text-5xl sm:text-6xl font-bold text-green-600 mb-6">{String(queueNumber).padStart(3, '0')}</div>
              )}
